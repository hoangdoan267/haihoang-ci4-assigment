...
//        this.enemyBulletControllerManager.add(enemyBulletController);
    ...
    public static EnemyPlaneController create(EnemyPlaneType enemyPlaneType, int x, int y){
        ...
        EnemyShotBehavior enemyShotBehavior =null;
        switch(enemyPlaneType){
            ...
            case WHITE:
                    ...
                    enemyPlaneController = new EnemyPlaneController(enemyPlane, whitePlaneDrawer, gameVector, new EnemyDiagonalShotBehavior());
               break;
        }
